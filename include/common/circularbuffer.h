...
public:
  ...
  */
  ...
  /** Returns a pointer at the "end" of the buffer, where new data can be
   * written
  */
  void *GetBuffer();
  ...
  */
  ...
  /** Returns a pointer at the "beginning" of the buffer, where data can be
   * pulled from
  */
  void *GetBufferStart();
};
