...
LIB_LFLAGS = -L$(APR_PATH)/lib -L$(APRUTIL_PATH)/lib -L$(LOG4CXX_PATH)/lib -L$(PROTOBUF_PATH)/lib -L$(JSON_PATH)/lib64 -L$(XERCES_PATH)/lib -L$(XML_SECURITY_PATH)/lib
